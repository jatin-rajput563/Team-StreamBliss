        ...
        <div className="max-w-[1138px] mx-auto flex flex-col md:flex-wrap lg:flex-row justify-between gap-12">
          <div className="lg:w-1/3">
            <div className="flex items-center mb-4">
              <img src={footerLogo} alt="footerLogo" className="lg:w-[360px] object-contain pointer-events-none" />
            </div>
            <Description descriptionText="StreamBliss is a secure, high-speed cloud platform designed for creators to store, share, and collaborate on videos, images, and documents." descriptionClass="!text-base max-lg:!w-full"/>
          </div>

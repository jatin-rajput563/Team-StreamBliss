...
//                   <div className={`flex flex-col justify-between min-h-[270px] w-full max-w-[437px] mx-auto transition-all duration-500
//                     ${activeIndex === index ? "opacity-100  scale-95" : "opacity-70  scale-95"}`}>
//                     <div>
//                       <div className="mb-6"><MEMBER_ICON /></div>
//                       <p className="text-[#FFFFFF] mb-6 text-base leading-[160%]">{Obj.text}</p>
//                     </div>
//                     <div className="flex items-center gap-[11px]">

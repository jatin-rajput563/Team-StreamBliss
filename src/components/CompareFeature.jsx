      ...
      <div className="max-w-[1140px] mx-auto pt-7 md:pt-12 lg:pt-20 pb-8 sm:pb-14 md:pb-24 lg:pb-36">
        ...
        <div className="overflow-x-auto rounded-lg border border-[#261C27] custom-scrollbar">
          <table className="min-w-[700px] w-full border-collapse">
            <thead className="bg-[#140016] text-white">
              <tr>
            ...
            <tbody>
              {COMPARE_FEATURE_DATA.map((obj, index) => (
                <tr key={index} className="border-b border-[#261C27] bg-[#070108BD] ">
                  <td className="py-3 px-4 sm:px-6 md:px-8  sm:text-base leading-[160%] bg-[#0E030F] text-sm  text-white opacity-70 lg:w-[258px] max-w-[258px] whitespace-nowrap">
                    {obj.feature}
                  </td>
                  <td className="py-3 px-4 sm:px-6 md:px-8  sm:text-base leading-[160%] text-center text-sm  text-white opacity-70 lg:w-[362px] whitespace-nowrap">
                    {obj.free}
                  </td>
                  <td className="py-3 px-4 sm:px-6 md:px-8  sm:text-base leading-[160%] text-center text-sm  text-white opacity-70 whitespace-nowrap">
                    {obj.pro}
                  </td>
                  <td className="py-3 px-4 sm:px-6 md:px-8  sm:text-base leading-[160%] text-center text-sm  text-white opacity-70 whitespace-nowrap">
                    {obj.creator}

          ...
          <div className="flex flex-row flex-wrap -mx-3 justify-center">
            {Pricing_Data.map((item, index) => (
              <div className="w-full lg:w-1/3 max-w-sm" key={index}>
                <div className="flex flex-col p-6 rounded-[20px] backdrop-blur-[16px] transition-all duration-300 h-full border border-[#1F1D1F] hover:border-[rgba(184,81,224,0.5)] hover:scale-105">

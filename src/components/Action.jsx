...
const Action = () => {
  return (
    <>
      <div id="about" className="px-3 relative pb-[60px] sm:pb-20 md:pb-35">
          ...
          <div className="flex flex-wrap gap-3 justify-between sm:mt-[27px]">
            <div className="max-[1088px]:mx-auto max-w-[558px]">
              {ACTION_DATA.map((item, index) => {
                ...
                return (
                  <div className="min-[1088px]:max-w-[558px] transition-all duration-200 ease-linear relative group box w-full bg-[#11001880] hover:bg-[#110018] hover:shadow-[0px_4px_62.1px_0px_#E649A21F] border rounded-2xl hover:border-transparent border-[#FFFFFF24] p-4.5 mt-6" key={index}>
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white opacity-70 leading-[160%]">{item.description}</p>
                      </div>
                    </div>
                  </div>
                );
            ...
            <img className="max-h-[478px] mt-3.5 w-full max-w-[494px] max-xl:mx-auto xl:flex xl:justify-end pointer-events-none" src={actionImg} alt="upload img" />
          </div>
        </div>
      </div>
    </>
